    ...
    return (
        <>
            ...
            <div className='container my-5'>
                <div className='row pt-5 g-lg-5 g-3 justify-content-center'>
                        ...
                        <div className='col col-md col-lg' key={index}>
                            <NavLink to={"/myreferral"} className={"text-decoration-none"}>
                                <div className='score-card position-relative border-radius-12 d-flex flex-column align-items-center justify-content-center p-3'>
                                    ...
                                    <p className='score-number font-40 montserrat-bold text-blue mb-0 pb-0 lh-1'>{item?.score}</p>
                                    <p className='score-text text-blue font-32 montserrat-medium mb-0 mt-0'>{item?.title}</p>
                                </div>
                            </NavLink>
