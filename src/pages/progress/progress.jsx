            ...
            <div className="col-lg-9 desktop-horizontal-layout col-md-12 col-12 pt-4 planet-section overflow-auto hidden-scrollbar">
              ...
              <div className="d-flex position-relative">
                ...
                <div className="col-lg-3 col-5 text-center text-dark-blue mt-4 pt-4 px-0">
                  ...
                  <p className='lh-sm text-blue font-16 space-grotesk-regular text-center planet-text'>{ContextHomeDataAPI?.admin_galaxies?.[0]?.milestones?.[0]?.milestone_description}<br /> <span className='space-grotesk-medium'>{ContextHomeDataAPI?.admin_galaxies?.[0]?.milestones?.[0]?.milestone_reward_meteors}</span></p>
                </div>

                <div
                  className={`col-lg-3 col-5`}
                >
                  <img
